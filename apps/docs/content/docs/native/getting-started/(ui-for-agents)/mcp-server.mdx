...
The MCP server currently supports **heroui-native** and [stdio transport](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio). Published at `@vx-oss/heroui-v3-native-mcp` on npm. View the source code on [GitHub](https://github.com/vezham/heroui-mcp).
...
**Need help?** [GitHub Issues](https://github.com/vezham/heroui-mcp/issues) | [Discord Community](https://discord.gg/heroui)

## Links

- [npm Package](https://www.npmjs.com/package/@vx-oss/heroui-v3-native-mcp)
- [GitHub Repository](https://github.com/vezham/heroui-mcp)
- [Contributing Guide](https://github.com/vezham/heroui-mcp/blob/main/CONTRIBUTING.md)