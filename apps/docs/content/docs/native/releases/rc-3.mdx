...
**Related PR:** [#309](https://github.com/vezham/heroui-native/pull/309)
...
**Related PR:** [#312](https://github.com/vezham/heroui-native/pull/312)
...
**Related PR:** [#313](https://github.com/vezham/heroui-native/pull/313)
...
**Related PR:** [#308](https://github.com/vezham/heroui-native/pull/308)
...
**Related PR:** [#314](https://github.com/vezham/heroui-native/pull/314)
...
- **[Issue #272](https://github.com/vezham/heroui-native/issues/272)**: Resolved `FullWindowOverlay` interfering with the React Native element inspector.

- **[Issue #280](https://github.com/vezham/heroui-native/issues/280)**: Fixed Avatar component and other Reanimated-dependent components breaking under Expo 55. The `combineStyles` function was destroying Reanimated animated style bindings via `StyleSheet.flatten`; it now returns style arrays to preserve `SharedValue` and `useAnimatedStyle` bindings.

**Related PRs:**

- [#308](https://github.com/vezham/heroui-native/pull/308)
- [#314](https://github.com/vezham/heroui-native/pull/314)
