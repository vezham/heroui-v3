...
**Related PR:** [#254](https://github.com/vezham/heroui-v3-native/pull/254)
...
**Related PR:** [#247](https://github.com/vezham/heroui-v3-native/pull/247)
...
**Related PR:** [#237](https://github.com/vezham/heroui-v3-native/pull/237)
...
**Related PR:** [#228](https://github.com/vezham/heroui-v3-native/pull/228)
...
**Related PR:** [#235](https://github.com/vezham/heroui-v3-native/pull/235)
...
**Related PR:** [#227](https://github.com/vezham/heroui-v3-native/pull/227)
...
**Related PR:** [#243](https://github.com/vezham/heroui-v3-native/pull/243)
...
**Related PR:** [#248](https://github.com/vezham/heroui-v3-native/pull/248)
...
**Related PR:** [#263](https://github.com/vezham/heroui-v3-native/pull/263)
...
**Related PR:** [#233](https://github.com/vezham/heroui-v3-native/pull/233)
...
**Related PR:** [#252](https://github.com/vezham/heroui-v3-native/pull/252)
...
**Related PR:** [#246](https://github.com/vezham/heroui-v3-native/pull/246)
...
**Related PR:** [#236](https://github.com/vezham/heroui-v3-native/pull/236)
...
**Related PR:** [#238](https://github.com/vezham/heroui-v3-native/pull/238)
...
- **[Issue #181](https://github.com/vezham/heroui-v3-native/issues/181)**: Fixed TextField error when inputting Chinese characters. The TextField component now properly handles multibyte characters and international input, ensuring smooth text entry for all languages including Chinese, Japanese, and Korean.

- **[Issue #219](https://github.com/vezham/heroui-v3-native/issues/219)**: Fixed Button `childrenToString()` returning `"[object Object]"` for multiple children. The function now properly handles React elements and complex children structures, preventing stringification issues when rendering button content.

- **[Issue #232](https://github.com/vezham/heroui-v3-native/issues/232)**: Fixed HeroUINativeProvider breaking with the recently released Uniwind Pro. The provider now properly handles Uniwind Pro compatibility, ensuring smooth integration with the latest Uniwind version.

- **[Issue #259](https://github.com/vezham/heroui-v3-native/issues/259)**: Fixed BottomSheet issue where opening quickly and starting a meeting would prevent it from opening again. The refactored animation system resolves this issue by improving the entering/exiting animation logic.

- **[Issue #261](https://github.com/vezham/heroui-v3-native/issues/261)**: Fixed `@gorhom/bottom-sheet` not being tree-shaken. The library now properly supports tree-shaking for unused dependencies.
...
- [#226](https://github.com/vezham/heroui-v3-native/pull/226)
- [#239](https://github.com/vezham/heroui-v3-native/pull/239)
