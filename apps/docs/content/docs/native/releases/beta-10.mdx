...
**Related PR:** [#174](https://github.com/vezham/heroui-v3-native/pull/174)
...
**Related PR:** [#182](https://github.com/vezham/heroui-v3-native/pull/182)
...
**Related PR:** [#176](https://github.com/vezham/heroui-v3-native/pull/176)
...
**Related PR:** [#170](https://github.com/vezham/heroui-v3-native/pull/170)
...
**Related PR:** [#179](https://github.com/vezham/heroui-v3-native/pull/179)

## Bug Fixes

This release includes fixes for the following issues:

- **[Issue #173](https://github.com/vezham/heroui-v3-native/issues/173)**: Fixed issue where `classNames={{container:"bg-x"}}` was not working for styling the backgroundColor of TextField.Input container
- **[Issue #177](https://github.com/vezham/heroui-v3-native/issues/177)**: Fixed button scale animation issue where the scale would sometimes stay at 0.9x and not bounce back after being pressed
- **[Issue #178](https://github.com/vezham/heroui-v3-native/issues/178)**: Fixed bug affecting component functionality
