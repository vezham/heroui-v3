...
**Related PR:** [#214](https://github.com/vezham/heroui-v3-native/pull/214)
...
**Related PR:** [#207](https://github.com/vezham/heroui-v3-native/pull/207)
...
**Related PR:** [#215](https://github.com/vezham/heroui-v3-native/pull/215)
...
**Related PR:** [#218](https://github.com/vezham/heroui-v3-native/pull/218)
...
**Related PR:** [#220](https://github.com/vezham/heroui-v3-native/pull/220)
...
**Related PR:** [#217](https://github.com/vezham/heroui-v3-native/pull/217)
...
- **[Issue #93](https://github.com/vezham/heroui-v3-native/issues/93)**: Fixed global border radius configuration not applying to Button component in hero-ui-native using Unwind. The Button component now properly respects border radius settings defined in the global theme configuration, ensuring consistent styling across the application.

- **[Issue #213](https://github.com/vezham/heroui-v3-native/issues/213)**: Fixed Select controlled mode (`isOpen`) not working. The Select component now properly handles controlled state when the `isOpen` prop is provided, allowing developers to manage Select open/close state externally with predictable behavior.

**Related PRs:**

- [#218](https://github.com/vezham/heroui-v3-native/pull/218)
- [#215](https://github.com/vezham/heroui-v3-native/pull/215)
