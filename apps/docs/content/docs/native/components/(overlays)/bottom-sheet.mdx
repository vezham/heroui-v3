...
See the complete example: [bottom-sheet-with-text-input.tsx](https://github.com/vezham/heroui-v3-native/blob/beta/example/src/components/bottom-sheet/with-text-input.tsx)
...
You can find more examples in the [GitHub repository](https://github.com/vezham/heroui-v3-native/blob/beta/example/src/app/(home)/components/bottom-sheet.tsx).
