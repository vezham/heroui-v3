...
You can find more examples in the [GitHub repository](<https://github.com/vezham/heroui-v3-native/blob/beta/example/src/app/(home)/components/description.tsx>).
