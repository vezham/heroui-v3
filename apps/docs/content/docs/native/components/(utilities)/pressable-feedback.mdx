...
You can find more examples in the [GitHub repository](<https://github.com/vezham/heroui-native/blob/main/example/src/app/(home)/components/pressable-feedback.tsx>).
