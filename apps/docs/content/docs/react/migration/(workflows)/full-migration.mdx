...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm uninstall @vx-oss/heroui-v3-react @vx-oss/heroui-v3-theme
    npm install @vx-oss/heroui-v3-styles @vx-oss/heroui-v3-react
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm remove @vx-oss/heroui-v3-react @vx-oss/heroui-v3-theme
    pnpm add @vx-oss/heroui-v3-styles @vx-oss/heroui-v3-react
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn remove @vx-oss/heroui-v3-react @vx-oss/heroui-v3-theme
    yarn add @vx-oss/heroui-v3-styles @vx-oss/heroui-v3-react
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun remove @vx-oss/heroui-v3-react @vx-oss/heroui-v3-theme
    bun add @vx-oss/heroui-v3-styles @vx-oss/heroui-v3-react
    ```
  </Tab>
</Tabs>
...
module.exports = {
  content: [
    "./src/**/*.{js,ts,jsx,tsx}",
    "./node_modules/@vx-oss/heroui-v3-theme/dist/**/*.{js,ts,jsx,tsx}",
  ],
  plugins: [heroui()],
  // ... other config
};
...
/* globals.css or main.css */
@import "tailwindcss";
@import "@vx-oss/heroui-v3-styles"; /* [!code highlight]*/
```

<Callout type="warning">
  Import order matters! Always import `tailwindcss` before `@vx-oss/heroui-v3-styles`.
</Callout>
...
import {Button} from "@vx-oss/heroui-v3-button";
import {Card} from "@vx-oss/heroui-v3-card";

// Or from main package
import {Button, Card} from "@vx-oss/heroui-v3-react";
```
...
import {Button, type ButtonProps} from "@vx-oss/heroui-v3-react";

// Compound component types are properly exported
import {Checkbox, type CheckboxProps} from "@vx-oss/heroui-v3-react";
...
- Update all component imports to `@vx-oss/heroui-v3-react`
