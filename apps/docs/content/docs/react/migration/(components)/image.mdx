...
**v2:** `<Image>` component from `@vx-oss/heroui-v3-react`  
...
```tsx
import { Image } from "@vx-oss/heroui-v3-react";
...
2. **Import Change**: Remove `import { Image } from "@vx-oss/heroui-v3-react"`
...
1. **Remove Import**: Remove `Image` from `@vx-oss/heroui-v3-react` imports
