...
```tsx
import { Autocomplete, AutocompleteItem } from "@vx-oss/heroui-v3-react";
...
```tsx
import { Autocomplete, Label, SearchField, ListBox, useFilter } from "@vx-oss/heroui-v3-react";
...
The v3 Autocomplete uses the `useFilter` hook (from React Aria, re-exported by `@vx-oss/heroui-v3-react`) to provide locale-aware filtering functions:

```tsx
import { useFilter } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Header, Separator } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { FieldError, Form } from "@vx-oss/heroui-v3-react";
