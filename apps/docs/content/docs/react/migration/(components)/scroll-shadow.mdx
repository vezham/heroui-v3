...
```tsx
import { ScrollShadow } from "@vx-oss/heroui-v3-scroll-shadow";
...
**v2:** Imported from `@vx-oss/heroui-v3-scroll-shadow` package  
**v3:** Imported from `@vx-oss/heroui-v3-react` unified package
...
- Update import from `@vx-oss/heroui-v3-scroll-shadow` to `@vx-oss/heroui-v3-react`
- Enhanced API with more configuration options
- Better shadow detection and visibility control
- Same orientation support (vertical / horizontal); import from `@vx-oss/heroui-v3-react`
