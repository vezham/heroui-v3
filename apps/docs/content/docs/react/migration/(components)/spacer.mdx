...
**v2:** `<Spacer>` component from `@vx-oss/heroui-v3-react`  
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Spacer } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Spacer, Button } from "@vx-oss/heroui-v3-react";
...
2. **Import Change**: Remove `import { Spacer } from "@vx-oss/heroui-v3-react"`
...
1. **Remove Import**: Remove `Spacer` from `@vx-oss/heroui-v3-react` imports
