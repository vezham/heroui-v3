...
```tsx
import { Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Button } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ...
    import { Label, Description, Kbd } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Label, Kbd } from "@vx-oss/heroui-v3-react";
