...
```tsx
import { Checkbox } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Checkbox, Label, Description } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Checkbox, CheckboxGroup } from "@vx-oss/heroui-v3-react";
  ...
  <Tab value="v3">
    ```tsx
    import { CheckboxGroup, Checkbox, Label, Description } from "@vx-oss/heroui-v3-react";
