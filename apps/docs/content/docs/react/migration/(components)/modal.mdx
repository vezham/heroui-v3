...
```tsx
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, useDisclosure } from "@vx-oss/heroui-v3-react";
...
```tsx
import { Modal, Button } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3 (Button trigger)", "v3 (Modal.Trigger)"]}>
  <Tab value="v2">
    ```tsx
    import { Modal, ModalContent, Button, useDisclosure } from "@vx-oss/heroui-v3-react";
  ...
  <Tab value="v3 (Modal.Trigger)">
    ```tsx
    import { Modal } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Modal, ModalContent, useDisclosure } from "@vx-oss/heroui-v3-react";
