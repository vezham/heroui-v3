...
```tsx
import { Card, CardHeader, CardBody, CardFooter } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Card, CardFooter, Image, Button } from "@vx-oss/heroui-v3-react";
  ...
  <Tab value="v3">
    ```tsx
    import { Card, Button } from "@vx-oss/heroui-v3-react";
