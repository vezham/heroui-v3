...
**v2:** `<Code>` component from `@vx-oss/heroui-v3-react`  
...
```tsx
import { Code } from "@vx-oss/heroui-v3-react";

export default function App() {
  return <Code>npm install @vx-oss/heroui-v3-react</Code>;
}
```
    ...
    export default function App() {
      return (
        <div className="space-y-4">
          <p>
            Install HeroUI with <Code>npm install @vx-oss/heroui-v3-react</Code>
          </p>
...
2. **Import Change**: Remove `import { Code } from "@vx-oss/heroui-v3-react"`
...
1. **Remove Import**: Remove `Code` from `@vx-oss/heroui-v3-react` imports
