...
```tsx
import { Listbox, ListboxItem, ListboxSection } from "@vx-oss/heroui-v3-react";
...
```tsx
import { ListBox, Label } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Description, Label } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  ...
  <Tab value="v3">
    ```tsx
    import { Header, Label, Separator } from "@vx-oss/heroui-v3-react";
