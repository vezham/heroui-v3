...
```tsx
import { Select, SelectItem } from "@vx-oss/heroui-v3-react";
...
```tsx
import { Select, Label, ListBox } from "@vx-oss/heroui-v3-react";
...
<Tabs items={["v2", "v3"]}>
  <Tab value="v2">
    ```tsx
    import { Select, SelectItem, SelectSection } from "@vx-oss/heroui-v3-react";
  ...
  <Tab value="v3">
    ```tsx
    import { Select, Label, ListBox, Header, Separator } from "@vx-oss/heroui-v3-react";
