...
<Callout type="warning">
  **Critical Build Issue Fixed**: This version (beta.4) had a critical build issue that has been fixed in **beta.5**. Please upgrade to `@vx-oss/heroui-v3-styles@3.0.0-beta.5` and `@vx-oss/heroui-v3-react@3.0.0-beta.5` to ensure proper TypeScript declaration generation and export resolution.
</Callout>
...
All of these can be imported directly from `@vx-oss/heroui-v3-react`:
...
- [GitHub PR #6121](https://github.com/vezham/heroui-v3/pull/6121)
