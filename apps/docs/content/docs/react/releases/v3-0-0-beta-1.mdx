...
// 3. Named exports
import { AvatarRoot, AvatarImage, AvatarFallback } from "@vx-oss/heroui-v3-react"
...
```tsx
import { Avatar, AvatarFallback } from "@vx-oss/heroui-v3-react"
...
```tsx
import type { AvatarRootProps } from "@vx-oss/heroui-v3-react"
...
- [GitHub PR #5872](https://github.com/vezham/heroui-v3/pull/5872)
