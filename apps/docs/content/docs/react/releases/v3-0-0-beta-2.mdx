...
```tsx
// Before
import type { SelectContentProps } from "@vx-oss/heroui-v3-react"

// After
import type { SelectPopoverProps } from "@vx-oss/heroui-v3-react"
```
...
```tsx
// Before
import { SelectContent } from "@vx-oss/heroui-v3-react"

// After
import { SelectPopover } from "@vx-oss/heroui-v3-react"
```
...
- [GitHub PR #5885](https://github.com/vezham/heroui-v3/pull/5885)
