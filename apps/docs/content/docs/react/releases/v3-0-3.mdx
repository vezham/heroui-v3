...
- **Tabs**: scope secondary-variant styles so nested tab groups no longer inherit the parent variant ([#6384](https://github.com/vezham/heroui/pull/6384))
...
- [GitHub PR #6441](https://github.com/vezham/heroui/pull/6441)
