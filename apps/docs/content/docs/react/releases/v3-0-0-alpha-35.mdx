...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash
    npm i @vx-oss/heroui-v3-styles@alpha @vx-oss/heroui-v3-react@alpha
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @vx-oss/heroui-v3-styles@alpha @vx-oss/heroui-v3-react@alpha
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add @vx-oss/heroui-v3-styles@alpha @vx-oss/heroui-v3-react@alpha
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @vx-oss/heroui-v3-styles@alpha @vx-oss/heroui-v3-react@alpha
    ```
  </Tab>
</Tabs>
...
**After:**
```tsx
import { Switch, SwitchGroup } from "@vx-oss/heroui-v3-react"
...
**Migration Steps:**
1. Import `SwitchGroup` separately: `import { Switch, SwitchGroup } from "@vx-oss/heroui-v3-react"`
...
**Tabs Example:**
```tsx
import { TabsRoot, TabListContainer, TabList, Tab, TabIndicator, TabPanel } from "@vx-oss/heroui-v3-react"
...
**Avatar Example:**
```tsx
import { Avatar, AvatarImage, AvatarFallback } from "@vx-oss/heroui-v3-react"
...
- For Switch migrations, verify that `SwitchGroup` is imported: `import { Switch, SwitchGroup } from "@vx-oss/heroui-v3-react"`
...
4. Report issues at: [GitHub Issues](https://github.com/vezham/heroui-v3/issues)
