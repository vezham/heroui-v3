...
The MCP server currently supports **@vx-oss/heroui-v3-react v3** only and [stdio transport](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio). Published at `@vx-oss/heroui-v3-react-mcp` on npm. View the source code on [GitHub](https://github.com/vezham/heroui-v3-mcp).
...
```bash
claude mcp add heroui-react -- npx -y @vx-oss/heroui-v3-react-mcp@latest
```
...
```json title="opencode.json"
{
  ...
  "mcp": {
    "heroui-react": {
      "type": "local",
      "command": ["npx", "-y", "@vx-oss/heroui-v3-react-mcp@latest"]
    }
  }
}
```
...
- [npm Package](https://www.npmjs.com/package/@vx-oss/heroui-v3-react-mcp)
