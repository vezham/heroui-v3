...
The MCP server currently supports **@vx-oss/heroui-v3-react v3** only and [stdio transport](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio). Published at `@vx-oss/heroui-v3-react-mcp` on npm. View the source code on [GitHub](https://github.com/vezham/heroui-mcp).
