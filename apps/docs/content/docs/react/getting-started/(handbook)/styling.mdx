...
```tsx
import { Button as HeroButton, type ButtonProps } from '@vx-oss/heroui-v3-react';
import { buttonVariants, tv, type VariantProps } from '@vx-oss/heroui-v3-styles';
...
View all component classes in [@vx-oss/heroui-v3-styles/components](https://github.com/vezham/heroui-v3/tree/main/packages/styles/components).
