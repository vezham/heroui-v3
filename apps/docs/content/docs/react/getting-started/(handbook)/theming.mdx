...
HeroUI's theming system is built on top of [Tailwind CSS v4](https://tailwindcss.com/docs/theme)'s theme. When you import `@vx-oss/heroui-v3-styles`, it uses Tailwind's built-in color palettes, maps them to semantic variables, automatically switches between light and dark themes, and uses CSS layers and the `@theme` directive for organization.
...
/* Base requirements */
@import "tailwindcss";
@import "@vx-oss/heroui-v3-styles/base" layer(base);
/* OR specific base file */
@import "@vx-oss/heroui-v3-styles/base/base.css" layer(base);

/* Theme variables */
@import "@vx-oss/heroui-v3-styles/themes/shared/theme.css" layer(theme);
@import "@vx-oss/heroui-v3-styles/themes/default" layer(theme);
/* OR specific theme files */
@import "@vx-oss/heroui-v3-styles/themes/default/index.css" layer(theme);
@import "@vx-oss/heroui-v3-styles/themes/default/variables.css" layer(theme);

/* Components (all components) */
@import "@vx-oss/heroui-v3-styles/components" layer(components);
/* OR specific component files */
@import "@vx-oss/heroui-v3-styles/components/index.css" layer(components);
@import "@vx-oss/heroui-v3-styles/components/button.css" layer(components);
@import "@vx-oss/heroui-v3-styles/components/accordion.css" layer(components);

/* Utilities (optional) */
@import "@vx-oss/heroui-v3-styles/utilities" layer(utilities);

/* Variants (optional) */
@import "@vx-oss/heroui-v3-styles/variants" layer(utilities);
```

> **Note**: Directory imports (e.g., `@vx-oss/heroui-v3-styles/components`) automatically resolve to their `index.css` file. Use explicit file paths (e.g., `@vx-oss/heroui-v3-styles/components/button.css`) to import individual component styles.

**Headless mode:** Build your own styles from scratch:

```css
@import "tailwindcss";
@import "@vx-oss/heroui-v3-styles/base/base.css";
...
For a complete reference, see: [Colors Documentation](/docs/handbook/colors), [Default Theme Variables](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/themes/default/variables.css), [Shared Theme Utilities](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/themes/shared/theme.css)
