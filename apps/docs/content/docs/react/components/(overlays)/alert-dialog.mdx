...
```tsx
import {AlertDialog} from "@vx-oss/heroui-v3-react";
```
...
The AlertDialog component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/alert-dialog.css)):
