...
```tsx
import { Popover } from '@vx-oss/heroui-v3-react';
```
...
The Popover component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/popover.css)):
