...
```tsx
import { Tooltip } from '@vx-oss/heroui-v3-react';
```
...
```tsx
import { Tooltip, Button } from '@vx-oss/heroui-v3-react';
...
The Tooltip component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/tooltip.css)):
