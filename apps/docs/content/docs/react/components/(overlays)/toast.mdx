...
```tsx
import { Toast, toast } from '@vx-oss/heroui-v3-react';
```
...
```tsx
import { Toast, Button, toast } from '@vx-oss/heroui-v3-react';
...
The Toast component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/toast.css)):
