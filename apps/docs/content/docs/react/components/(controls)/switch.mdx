...
```tsx
import { Switch, SwitchGroup, Label } from '@vx-oss/heroui-v3-react';
```
...
```tsx
import { Switch, Label } from '@vx-oss/heroui-v3-react';
...
The Switch component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/switch.css)):
...
The SwitchGroup component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/switch-group.css)):
