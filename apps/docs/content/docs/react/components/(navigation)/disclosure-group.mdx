...
```tsx
import {DisclosureGroup} from '@vx-oss/heroui-v3-react';
```
...
```tsx
import {DisclosureGroup, Disclosure} from '@vx-oss/heroui-v3-react';
...
The DisclosureGroup component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/disclosure-group.css)):
