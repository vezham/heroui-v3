...
```tsx
import { ColorPicker, ColorArea, ColorSlider, ColorSwatch, Label } from '@vx-oss/heroui-v3-react';
...
The ColorPicker component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/color-picker.css)):
