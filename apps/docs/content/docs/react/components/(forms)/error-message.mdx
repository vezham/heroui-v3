...
```tsx
import { ErrorMessage } from '@vx-oss/heroui-v3-react';
```
...
The ErrorMessage component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/error-message.css)):
