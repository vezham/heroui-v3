...
links:
  ...
  storybook: Components/Forms/TimeField
---

## Import

```tsx
import { TimeField } from '@vx-oss/heroui-v3-react';
```
...
```tsx
import {TimeField, Label, DateInputGroup, Description, FieldError} from '@vx-oss/heroui-v3-react';
...
```tsx
import {TimeField, Label, DateInputGroup, Description} from '@vx-oss/heroui-v3-react';
