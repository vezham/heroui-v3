...
```tsx
import { Dropdown } from '@vx-oss/heroui-v3-react';
```
...
```tsx
import { Dropdown, Button, Label, Description, Header, Kbd, Separator } from '@vx-oss/heroui-v3-react';
...
```tsx
import { Dropdown, Button } from '@vx-oss/heroui-v3-react';
...
The Dropdown component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/dropdown.css)):
...
#### Menu Classes
- `.menu` - Base menu container ([menu.css](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/menu.css))
  - `[data-slot="separator"]` - Separator elements within the menu

#### MenuItem Classes
- `.menu-item` - Base menu item container ([menu-item.css](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/menu-item.css))
...
#### MenuSection Classes
- `.menu-section` - Base menu section container ([menu-section.css](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/menu-section.css))
...
```tsx
import { Dropdown, Button, Label } from '@vx-oss/heroui-v3-react';
...
```tsx
import { Dropdown, Button, Label, Header, Separator } from '@vx-oss/heroui-v3-react';
