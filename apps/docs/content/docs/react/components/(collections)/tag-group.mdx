...
```tsx
import { TagGroup } from '@vx-oss/heroui-v3-react';
```
...
```tsx
import { TagGroup, Tag, Label, Description, ErrorMessage } from '@vx-oss/heroui-v3-react';
...
```tsx
import { TagGroup, Tag, Label } from '@vx-oss/heroui-v3-react';
...
The TagGroup component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/tag-group.css) and [tag.css](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/tag.css)):
