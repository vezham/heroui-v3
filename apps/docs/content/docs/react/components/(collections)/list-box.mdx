...
```tsx
import { ListBox } from '@vx-oss/heroui-v3-react';
```
...
```tsx
import { ListBox, Label, Description, Header } from '@vx-oss/heroui-v3-react';
...
The ListBox component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/list-box.css)):
...
```tsx
import { ListBox, Label, Description } from '@vx-oss/heroui-v3-react';
...
<ListBox aria-label="Users" selectionMode="single">
  ...
  <ListBox.Item id="2" textValue="Alice">
    <Label>Alice</Label>
    <Description>alice@vezham.com</Description>
  </ListBox.Item>
</ListBox>
```
...
```tsx
import { ListBox, Header, Separator } from '@vx-oss/heroui-v3-react';
...
```tsx
import { ListBox, Selection } from '@vx-oss/heroui-v3-react';
...
```tsx
import { ListBox, ListBoxItemIndicator } from '@vx-oss/heroui-v3-react';
