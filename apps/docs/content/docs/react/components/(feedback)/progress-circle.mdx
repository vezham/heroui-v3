...
The ProgressCircle component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/progress-circle.css)):
