...
```tsx
import { Meter, Label } from '@vx-oss/heroui-v3-react';
```
...
The Meter component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/meter.css)):
