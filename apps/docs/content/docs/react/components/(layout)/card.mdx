...
Card uses [BEM](https://getbem.com/) naming for predictable styling, ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/card.css)):
