...
```tsx
import { Surface, Input, TextArea } from '@vx-oss/heroui-v3-react';
...
The Surface component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/surface.css)):
...
import { SurfaceContext } from '@vx-oss/heroui-v3-react';
