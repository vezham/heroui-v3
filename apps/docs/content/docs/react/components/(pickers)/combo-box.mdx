...
```tsx
import { ComboBox } from '@vx-oss/heroui-v3-react';
```
...
```tsx
import { ComboBox, Input, Label, Description, Header, ListBox, Separator } from '@vx-oss/heroui-v3-react';
...
```tsx
import { ComboBox, Input } from '@vx-oss/heroui-v3-react';
...
The ComboBox component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/combo-box.css)):
...
```tsx
import { ComboBox, Input, Label, ListBox, Header, Separator } from '@vx-oss/heroui-v3-react';
...
```tsx
import { Collection, ComboBox, EmptyState, Input, Label, ListBox, ListBoxLoadMoreItem, Spinner } from '@vx-oss/heroui-v3-react';
...
```tsx
import { ComboBox, FieldError, Input, Label, ListBox } from '@vx-oss/heroui-v3-react';
