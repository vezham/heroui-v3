...
```tsx
import { Badge } from '@vx-oss/heroui-v3-react';
```
...
The Badge component uses these CSS classes ([View source styles](https://github.com/vezham/heroui-v3/blob/timeline/packages/styles/components/badge.css)):
